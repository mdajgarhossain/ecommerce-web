                                        ...
                                        <SwiperSlide>
                                            <div className="tp-slide-item">
                                                ...
                                                <div className="tp-slide-item__img">
                                                    <img src="/assets/img/slider/Hero-Image-Slide.png" alt="" />
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="tp-slide-item">
                                                ...
                                                <div className="tp-slide-item__img">
                                                    <img src="/assets/img/slider/Hero-Image-Slide-3.png" alt="" />
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="tp-slide-item">
                                                ...
                                                <div className="tp-slide-item__img">
                                                    <img src="/assets/img/slider/Hero-Image-Slide-2.png" alt="" />
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                    </Swiper>
                            ...
                            <div className="row">
                                    ...
                                    <div className="tpslider-banner tp-slider-sm-banner mb-30">
                                        ...
                                        <Link href="/shop">
                                            <div className="tpslider-banner__img">
                                                <img src="/assets/img/slider/Sub-Image-1.png" alt="" />
                                ...
                                <div className="col-lg-12 col-md-6">
                                    <div className="tpslider-banner">
                                        ...
                                        <Link href="/shop">
                                            <div className="tpslider-banner__img">
                                                <img src="/assets/img/slider/Sub-Image-2.png" alt="" />
                                                <div className="tpslider-banner__content">
